...
============================================================================&echo.&echo
&echo.&echo
============================================================================&choice /n /c YN /m "Press 'y' to continue" & if errorlevel 2 exit) || (echo The connection to my KMS server failed! Trying to connect to another one... & echo Please wait... & echo. & echo. & set /a i+=1 & goto server)
:notsupported
